import { flags, SfdxCommand, Result } from '@salesforce/command';
...
import { IFSAJ_Release__c, IFSAJ_Analyze_Job_Assignment__c, IFSummary, IFSAJ_Analyze_Result__c, IFJob } from '../../lib/analyze_object_definition';
...
export default class analyze extends SfdxCommand {
  ...
  public async run(): Promise<AnyJson> {
    ...
    const a = await fnGetOrganization(conn);
    console.log (a);
